  ...
  <>
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M53.5683 39L55.5437 34.3851L49.3528 23.7098L52.2483 13.0836L49.3539 12.2949L46.1288 24.1305L52.179 34.5631L50.0881 39H38V52H62V39H53.5683Z"
        fill="white"
      />
    </mask>
  ...
  <>
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M50 13C38.9543 13 30 21.9543 30 33V36H21C20.4477 36 20 36.4477 20 37V51C20 51.5523 20.4477 52 21 52H79C79.5523 52 80 51.5523 80 51V37C80 36.4477 79.5523 36 79 36H70V33C70 21.9543 61.0457 13 50 13Z"
        fill="white"
      />
    </mask>
    <g mask="url(#bulb1)">
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M50 36C52.2091 36 54 35.028 54 31.7143C54 28.4006 52.2091 24 50 24C47.7909 24 46 28.4006 46 31.7143C46 35.028 47.7909 36 50 36Z"
        fill="white"
        fillOpacity="0.6"
      />
      <rect
...
export const Bulb2 = observer(() => (
  <>
    ...
    <g mask="url(#bulb2)">
      ...
      />
      <path
        d="M49 3.5C53.9315 3.5 58.366 5.62814 61.4352 9.01616"
        stroke="white"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M49.8284 26L40.8284 17L38 19.8284L48 29.8284V40H52V29.9706L62.1421 19.8284L59.3137 17L50.3137 26H49.8284Z"
        fill="white"
        fillOpacity="0.8"
      />
    </g>
  ...
  <>
    <g filter="url(#glowingBulb2Topfilter)">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M30 33C30 21.9543 38.9543 13 50 13V13C61.0457 13 70 21.9543 70 33V44H30V33Z"
        fill="white"
        fillOpacity="0.3"
      />
    </g>
    ...
    <mask
      ...
      height="16"
    >
      <rect x="20" y="36" width="60" height="16" rx="1" fill="white" />
    </mask>
    <g mask="url(#glowingBulb2)" />
    <defs>
      <filter
        id="glowingBulb2Topfilter"
        x="22"
        y="5"
        width="56"
        height="47"
  ...
  <>
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M71.2104 40C78.8499 33.2931 84.6313 20.6882 84 14C83.8635 12.5535 85.9998 12.2993 87 14C91.418 21.5124 89.7172 36.0672 89.1535 40H92V52H66V40H71.2104ZM16.521 13.7408C16.521 21.2733 21.4918 33.445 29.2618 40H34V52H8V40H11.2251C10.6299 36.4414 8.52929 21.6012 13.4337 14.1009C14.3353 12.7219 16.521 12.6807 16.521 13.7408Z"
        fill="white"
      />
    </mask>
    <g mask="url(#horns)">
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M15.4558 13H31.5689V40H20.8201C13.3712 32.1499 15.4558 13 15.4558 13Z"
        fill="white"
        fillOpacity="0.4"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M84.8203 13H92.5691V40H81.8203C87.5713 32.1946 84.8203 13 84.8203 13Z"
        fill="white"
        fillOpacity="0.4"
      />
    </g>
...
export const Plankton = () => (
  <>
    <path
      d="M13.5 52V22C13.5 10.0187 21.2949 0.5 30.6957 0.5H69.3043C78.7051 0.5 86.5 10.0187 86.5 22V52H13.5Z"
      fill="white"
      fillOpacity="0.5"
      stroke="#ECECEC"
    />
    <path
      d="M24 28C24 28 28.9939 43.7946 38 45"
      stroke="#6C9D91"
      strokeWidth="3.2"
    />
    <path
      d="M75 35C75 35 70.0061 44.2909 61 45"
      stroke="#6C9D91"
      strokeWidth="3.2"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M36 1C37.8049 4.09305 39.8049 9.68898 42 18.0526L39.75 19C38.1056 10.7362 36.8743 4.73616 36 1Z"
      fill="#08754F"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M64 1C62.1951 4.09305 60.1951 9.68898 58 18.0526L60.25 19C61.8944 10.7362 63.1257 4.73616 64 1Z"
      fill="#08754F"
    />
    <path
      d="M37 23C37 15.8203 42.8203 10 50 10V10C57.1797 10 63 15.8203 63 23V52H37V23Z"
      fill="#78ADA0"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M50 28C53.3137 28 56 25.3137 56 22C56 18.6863 53.3137 16 50 16C46.6863 16 44 18.6863 44 22C44 25.3137 46.6863 28 50 28Z"
      fill="#F7EDA2"
    />
    <rect x="24" y="15" width="2" height="37" fill="#2E3539" />
    <rect x="75" y="21" width="2" height="31" fill="#2E3539" />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M25 21C27.7614 21 30 18.7614 30 16C30 13.2386 27.7614 11 25 11C22.2386 11 20 13.2386 20 16C20 18.7614 22.2386 21 25 21Z"
      fill="#2E3539"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M76 30C78.7614 30 81 27.7614 81 25C81 22.2386 78.7614 20 76 20C73.2386 20 71 22.2386 71 25C71 27.7614 73.2386 30 76 30Z"
      fill="#2E3539"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M50 25C51.1046 25 52 23.6569 52 22C52 20.3431 51.1046 19 50 19C48.8954 19 48 20.3431 48 22C48 23.6569 48.8954 25 50 25Z"
      fill="#EF3838"
    />
    <path
      d="M42 14.7346L44.849 13C46.6825 16.3657 53.3175 16.3657 55.151 13L58 14.7346C54.9019 20.4218 45.0981 20.4218 42 14.7346Z"
      fill="#232827"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M44 30C44 36.4183 45.2851 41 50.5 41C55.7149 41 57 36.4183 57 30"
      fill="#94231A"
    />
    <mask
      id="plankton"
    ...
    <g mask="url(#plankton)">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M48.0625 46C50.3062 46 52.125 44.2091 52.125 42C52.125 39.7909 50.3062 38 48.0625 38C45.8188 38 44 39.7909 44 42C44 44.2091 45.8188 46 48.0625 46Z"
        fill="#EC7651"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M52.9375 46C55.1812 46 57 44.2091 57 42C57 39.7909 55.1812 38 52.9375 38C50.6938 38 48.875 39.7909 48.875 42C48.875 44.2091 50.6938 46 52.9375 46Z"
        fill="#EC7651"
      />
      <rect x="44" y="30" width="13" height="3.2" fill="#ECFAF7" />
    </g>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M76 38C78.2091 38 80 36.2091 80 34C80 31.7909 78.2091 30 76 30C73.7909 30 72 31.7909 72 34C72 36.2091 73.7909 38 76 38Z"
      fill="#78ADA0"
    />
    <rect x="11" y="46" width="78" height="6" fill="#2E3539" />
  </>
)
