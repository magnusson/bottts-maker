export const Antenna1 = () => (
  <>
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M13 9C14.1046 9 15 8.10457 15 7C15 5.89543 14.1046 5 13 5C11.8954 5 11 5.89543 11 7C11 8.10457 11.8954 9 13 9Z"
      fill="white"
    />
  </>
)
  ...
  <>
    ...
    <g mask="url(#squareAssymetric)">
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M161 25C163.761 25 166 22.7614 166 20C166 17.2386 163.761 15 161 15C158.239 15 156 17.2386 156 20C156 22.7614 158.239 25 161 25Z"
        fill="white"
        fillOpacity="0.6"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M161 41C163.761 41 166 38.7614 166 36C166 33.2386 163.761 31 161 31C158.239 31 156 33.2386 156 36C156 38.7614 158.239 41 161 41Z"
        fill="white"
        fillOpacity="0.6"
      />
    </g>
